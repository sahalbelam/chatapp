...
export default function Component() {
  return (
    <div className="flex flex-col min-h-screen">
          ...
          <div className="container px-4 md:px-6">
            <div className="flex flex-col items-center space-y-4 text-center">
              ...
              <div className="space-x-4">
                <Button size="lg"><Link to={"/signup"}>Get Started</Link></Button>
      ...
      <footer className="bg-slate-800 flex flex-col gap-2 sm:flex-row py-6 w-full shrink-0 items-center px-4 md:px-6 border-t">
        <p className="text-xs text-gray-100">© 2024 ChatCreator. All rights reserved. created by sahal belam</p>
        <nav className="text-gray-100 sm:ml-auto flex gap-4 sm:gap-6">
